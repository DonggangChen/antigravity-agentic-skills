...
> **Source:** [Nielsen Norman Form Design](https://www.nngroup.com/articles/web-form-design/) & [React Hook Form](https://react-hook-form.com/)

### Phase 1: Structure & validation
- [ ] **Schema**: Define validation schema with Zod/Yup consistent with backend.
- [ ] **Labels**: Put clear, accessible (`htmlFor`) labels for every input.
- [ ] **Grouping**: Separate related fields with `<fieldset>` or visual groups.

### Phase 2: User Experience
- [ ] **Defaults**: Add smart defaults (country, phone code).
- [ ] **Feedback**: Show errors before submit (onBlur) or while typing.
- [ ] **Loading**: Disable button and show spinner during submit.

### Phase 3: Accessibility
- [ ] **Keyboard**: Can you fill the entire form using only Tab key?
- [ ] **Error Focus**: Does focus go to the first error field when there is an error?

### Checkpoints
| Phase | Verification                                    |
| ----- | ----------------------------------------------- |
| 1     | Are required fields (*) clearly indicated?      |
| 2     | Does the form submit when Enter key is pressed? |
| 3     | Does screen reader read the error aloud?        |
