...
*GitHub Project Automation v2.1 - Enhanced*

## 🔄 Workflow

> **Source:** [GitHub Issues & Projects Guide](https://docs.github.com/en/issues)

### Phase 1: Project Board Setup
- [ ] **Fields**: Define 'Status', 'Priority', 'Size' (T-Shirt sizing) fields.
- [ ] **Views**: Create "My Tasks" view for Developer, "Roadmap" view for Manager.
- [ ] **Automation**: Enable "Move to Done when PR merged" rule.

### Phase 2: Issue Lifecycle
- [ ] **Template**: Use mandatory field templates (YAML form) for Bug and Feature Request.
- [ ] **Triage**: Label incoming issues with swarm or bot (`bug`, `triage-needed`).
- [ ] **Link**: Link every PR to an issue (`Closes #123`).

### Phase 3: Sprint Planning
- [ ] **Milestone**: Assign Issues to Milestones (Sprint 1, v1.0).
- [ ] **Burn-up**: Track progress with GitHub Insights/Charts.

### Checkpoints
| Phase | Verification                                           |
| ----- | ------------------------------------------------------ |
| 1     | Is it clear who owns a card on the Board in 3 seconds? |
| 2     | Are "Stale" (old) issues automatically closed?         |
| 3     | Does Roadmap view reflect real status?                 |
