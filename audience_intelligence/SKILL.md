...
> **Source:** [Data-Driven Marketing Guide](https://hbr.org/topic/marketing)
...
### Phase 2: Segmentation (AI/Manual)
- [ ] **Demographic**: Age, Location, Income (Traditional).
- [ ] **Psychographic**: Values, Interests (Modern).
- [ ] **Behavioral**: Purchase frequency, Loyalty (Data-driven).

### Phase 3: Persona Creation
- [ ] **Draft Profile**: Give names like "Tech-Savvy Tina".
- [ ] **Empathy Map**: What does s/he see, hear, think, feel?
- [ ] **Influencer Match**: Who does this persona follow?

### Checkpoints
| Phase | Verification                                       |
| ----- | -------------------------------------------------- |
| 1     | Is data source reliable and up-to-date?            |
| 2     | Are segments clearly distinct?                     |
| 3     | Is persona realistic (data-driven, not imaginary)? |
