...
### Phase 1: Operational Excellence & Security
- [ ] **Ops**: Are Runbooks ready? Is the process clear in case of failure (Rollback)?
- [ ] **Security**: Has IAM "Least Privilege" been applied? Is S3 Public Access disabled?
- [ ] **Encryption**: Is data encrypted at-rest (KMS) and in-transit (HTTPS)?

### Phase 2: Reliability & Performance
- [ ] **Backup**: Is Database PITR (Point-in-Time Recovery) enabled?
- [ ] **Scaling**: Have Auto-scaling triggers (CPU/RAM/Requests) been tested?
- [ ] **Caching**: Are CloudFront/ElastiCache layers correctly configured?

### Phase 3: Cost Optimization
- [ ] **Right-Sizing**: Are Instance/Lambda sizes appropriate for CPU/RAM usage?
- [ ] **Lifecycle**: Are there Lifecycle rules (IA/Glacier) for S3 data?
- [ ] **Alerts**: Are budget alarms (AWS Budgets) set up?

### Checkpoints
| Phase | Verification                                          |
| ----- | ----------------------------------------------------- |
| 1     | Security Score > 90% (Trusted Advisor / Security Hub) |
| 2     | 99.9% availability achieved in Load Testing           |
| 3     | Estimated cost is within budget limits                |
