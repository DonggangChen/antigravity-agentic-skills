...
> **Source:** [12 Factor CLI Apps](https://medium.com/@jdxcode/12-factor-cli-apps-dd3c227a0e46)

### Phase 1: Design & UX
- [ ] **Interface**: Design Command/Sub-command structure (`verb noun` pattern).
- [ ] **Flags**: Determine Global (`--verbose`) and local flags.
- [ ] **Output**: Plan separation of `stdout` (data) and `stderr` (log).

### Phase 2: Implementation
- [ ] **Skeleton**: Set up Framework (Cobra/Typer/Clap).
- [ ] **Logic**: Write Business logic, abstract I/O operations.
- [ ] **Interactivity**: Add color/prompt with TTY check.

### Phase 3: Polish
- [ ] **Help**: Write `--help` texts and examples.
- [ ] **Completion**: Generate Shell completion scripts.
- [ ] **Man Pages**: Create documentation.

### Checkpoints
| Phase | Verification                                                            |
| ----- | ----------------------------------------------------------------------- |
| 1     | Is command structure "intuitive"?                                       |
| 2     | When `myscript > file.txt`, do logs mix into the file? (Should not mix) |
| 3     | Is Startup time < 50ms?                                                 |
