...
> **Source:** [Scrum Guide 2020](https://scrumguides.org/) & [Mountain Goat Software (Mike Cohn)](https://www.mountaingoatsoftware.com/agile/scrum)

### Phase 1: Sprint Preparation (Planning)
- [ ] **Definition of Ready (DoR)**: Set clear criteria for a story to be taken into sprint (INVEST: Independent, Negotiable, Valuable, Estimable, Small, Testable).
- [ ] **Capacity Check**: Calculate realistic capacity by deducting holidays, sickness, and meeting times.
- [ ] **Goal Setting**: Set an achievable "Sprint Goal", not just a "work list".

### Phase 2: Sprint Execution (Daily & Removal)
- [ ] **Blocker Management**: Add every impediment heard in the Standup to the "Impediment Log" immediately and take ownership.
- [ ] **Burndown Hygiene**: Check if the Burndown chart reflects reality. Diagnose work not "Done" early.
- [ ] **Scope Protection**: Mark new work coming in mid-sprint as "Scope Creep" and negotiate with the Product Owner.

### Phase 3: Sprint Closing (Review & Retro)
- [ ] **Definition of Done (DoD)**: Count only work that is tested and deployable as "Done", not just coded.
- [ ] **Actionable Retro**: Derive concrete actions like "let's have code review hour every morning at 10:15" instead of abstract ones like "let's communicate better".
- [ ] **Velocity Tracking**: Update the team's average velocity and use it for future planning.

### Checkpoints
| Phase | Verification                                          |
| ----- | ----------------------------------------------------- |
| 1     | Is the Sprint Goal clear and understood by everyone?  |
| 2     | Are Retrospective actions tracked in the next sprint? |
| 3     | Do Stakeholders participate in the Review meeting?    |
