...
> **Source:** [Multi-Agent Patterns (Microsoft)](https://microsoft.github.io/multi-agent-reference-architecture/docs/reference-architecture/Patterns.html)
...
### Phase 2: Prompt Engineering (Delegation)
...
| Phase | Verification                                        |
| ----- | --------------------------------------------------- |
| 1     | Architecture diagram is clear, roles are distinct   |
| 2     | Prompts are in "Delegation Structure" format        |
| 3     | Router directs to the correct agent (>90% accuracy) |
| 4     | No infinite loops or context loss                   |
