...
router_kit: AIKit
description: Tailwind CSS v4, design tokens, responsive patterns and utility-first CSS best practices.
metadata:
  skillport:
    category: design
...
> Tailwind CSS v4 and utility-first CSS best practices guide.

---

## 📋 Table of Contents

1. [Tailwind v4 Innovations](#1-tailwind-v4-innovations)
...
```css
/* v4: Automatic - only used classes included in bundle */
```
...
> **Source:** [Tailwind CSS v4.0 Release](https://tailwindcss.com/blog/tailwindcss-v4-beta) & [Adam Wathan's Design Tips](https://twitter.com/adamwathan)
