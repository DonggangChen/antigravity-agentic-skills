...
> **Source:** [Kent Beck - Test Driven Development by Example](https://www.oreilly.com/library/view/test-driven-development/0321146530/) & [Google Testing Blog](https://testing.googleblog.com/)

### Phase 1: RED - Test-First Approach
- [ ] **Interface Design**: Determine how the code should work (Input/Output) and write the test.
- [ ] **Fail Confirmation**: Run the test and see it fail (Red) because the code hasn't been written yet.
- [ ] **Assertion Clarity**: Ensure you get a clear error message explaining why the test failed.

### Phase 2: GREEN - Implementation
- [ ] **Minimal Code**: Write only the simplest/minimal code required to pass the test.
- [ ] **Pass Verification**: Verify that all tests return "Green".
- [ ] **Avoid Over-Engineering**: Do not implement features outside the test scope.

### Phase 3: REFACTOR - Clean Code
- [ ] **Code Cleanup**: Optimize code according to SOLID principles, correct naming.
- [ ] **Test Refinement**: Improve test readability, optimize repetitions (`setup/teardown`).
- [ ] **Regression Check**: Verify that tests remain green after each refactoring step.

### Checkpoints
| Phase | Verification                                                   |
| ----- | -------------------------------------------------------------- |
| 1     | Do tests test "Behavior" rather than "Implementation Details"? |
| 2     | Is each test function independent (Isolated)?                  |
| 3     | Is the code coverage target (80%+) met?                        |
