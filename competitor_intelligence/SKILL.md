...
> **Source:** [Strategy Analytics - AI-Driven CI](https://www.strategyanalytics.com/) & [Competitor Monitoring Repos](https://github.com/padiel-g/ISP-Market-Arbitrage-Competitive-Intelligence)

### Phase 1: Signal Identification & Setup
- [ ] **Data Sources**: Identify competitors' pricing pages, career pages (hiring trends) and press site RSS.
- [ ] **Automation Setup**: Automate data flow with Python-based web scraping or commercial CI (Competitive Intelligence) tools.
- [ ] **Categorization**: Label collected data as "Product", "Market", "Talent" and "Financial".

### Phase 2: Strategic Signal Analysis
- [ ] **Trend Detection**: Detect anomalies in data (e.g., mass layoffs or huge discounts).
- [ ] **Product Teardown**: Analyze competitor product updates and new patent applications.
- [ ] **Sentiment Analysis**: Monitor complaints of competitor customers in G2/Capterra reviews.

### Phase 3: Intelligence Distribution
- [ ] **Battlecards**: Create up-to-date "How we win" cards for sales team.
- [ ] **Alerting**: Announce critical developments (M&A, big pivot) instantly to relevant departments via Slack/Email.
- [ ] **Quarterly CI Review**: Report new direction of market every quarter.

### Checkpoints
| Phase | Verification                                                                   |
| ----- | ------------------------------------------------------------------------------ |
| 1     | Is competitor technology change (e.g. CMS or Cloud provider change) monitored? |
| 2     | Did collected intelligence turn directly into a product decision?              |
| 3     | Is data compliant with legal and ethical CI (SCIP) standards?                  |
